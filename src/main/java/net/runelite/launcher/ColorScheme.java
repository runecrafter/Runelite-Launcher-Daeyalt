...
public class ColorScheme
{
	...
	public static final Color BRAND = new Color(65, 98, 131);

	/* The blue color used for the branding's accents, with lowered opacity */
	public static final Color BRAND_TRANSPARENT = new Color(252, 244, 236, 255);
	...
	public static final Color PROGRESS_ERROR_COLOR = new Color(63, 94, 130);
}